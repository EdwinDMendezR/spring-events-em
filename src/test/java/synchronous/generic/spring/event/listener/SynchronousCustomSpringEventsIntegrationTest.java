...
@ContextConfiguration(classes = { GenericSpringEventListenerConfig.class }, loader = AnnotationConfigContextLoader.class)
public class SynchronousCustomSpringEventsIntegrationTest {
    ...
    public void testCustomSpringEvents() {
        ...
        publisher.publishCustomEvent("publishCustomEvent");
    ...
    public void testGenericSpringEvent() {
        ...
        publisher.publishGenericEvent("testGenericSpringEvent", true);
    ...
    public void testGenericSpringEventNotProcessed() {
        isTrue(!listener.isHitSuccessfulEventHandler(), "The initial value should be false");
        publisher.publishGenericEvent("testGenericSpringEventNotProcessed", false);
